...
<body id="page-top">
   ...
   <div class="container">
        <form method="POST">
            ...
            <div class="mb-3 my-3">
                <label>Name</label>
                <input type="text" class="form-control" placeholder="Medicine name" name="nama">
            </div>
            <div class="mb-3">
                <label>Price</label>
                <input type="text" class="form-control" placeholder="Medicine price" name="harga">
            </div>

<?php
// INSERT INTO `rekam_medis` (`id_rekam_medis`, `keluhan`, `diagnosa`, `obat`, `tanggal`, `id_pasien`) VALUES (NULL, 'sakit perut', 'diare', 'maag', '2023-01-17', '30');
include "connect.php";
if (isset($_POST['submit'])) {
    $id = $_POST['Id'];
    $complaints = $_POST['Keluhan'];
    $diagnose= $_POST['Diagnosa'];
    // $status = implode("", $_POST['gender']);
    $date = $_POST['Tanggal'];
    $medicine = $_POST['Obat'];


    $ins_pasien = "
    INSERT INTO `rekam_medis` (`id_rekam_medis`, `keluhan`, `diagnosa`, `obat`, `tanggal`, `id_pasien`) 
    VALUES (NULL, '$complaints', '$diagnose', '$medicine', '$date', '$id')
    ";
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 mb-0 text-gray-800">Add Medical Records</h1>
        ...
        <form method="POST">
            <div class="mb-3 my-3">
                ...
                <select class="form-select" aria-label="Default select example" name="Id">
                    <option disable selected>Pasien</option>
                    <!-- query select pasien  -->
                    <?php
                    $sel_pasien = "select id_pasien,nama_pasien from pasien";
            ...
            <div class="mb-3 my-3">
                ...
                <input type="text" class="form-control" placeholder="Complaints" name="Keluhan">
            </div>
            <div class="mb-3">
                <label>Diagnose</label>
                <input type="text" class="form-control" placeholder="Diagnose" name="Diagnosa">
            </div>
            <div class="mb-3">
                <label>Medicine</label>
                <input type="text" class="form-control" placeholder="Medicine" name="Obat">
            </div>
            <div class="mb-3">
                <label>date</label>

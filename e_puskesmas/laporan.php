            ...
            <div id="content">
               ...
               <form  
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
             <div class="container">
      <button type="submit" class="btn btn-danger my-5">
        <a href="print_laporan.php?keyword='.$keyword.'" class="text-light">Print</a>
      </button>
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          <?php
            if (isset($_POST['cari'])) {
                ...
                $sel_pasien = " SELECT rm.id_rekam_medis, p.nama_pasien,p.alamat,rm.keluhan, rm.diagnosa, rm.obat, rm.tanggal,tr.metode_pembayaran
                FROM `rekam_medis` rm 
                INNER JOIN pasien p 
                on rm.id_pasien = p.id_pasien 
                inner join transaksi tr
                on tr.id_rekam_medis = rm.id_rekam_medis WHERE p.nama_pasien like '$keyword' ";
            }
            else{
                $sel_pasien = "SELECT rm.id_rekam_medis, p.nama_pasien,p.alamat,rm.keluhan, rm.diagnosa, rm.obat, rm.tanggal,tr.metode_pembayaran
                FROM `rekam_medis` rm 
                ...
                on rm.id_pasien = p.id_pasien 
                inner join transaksi tr
                on tr.id_rekam_medis = rm.id_rekam_medis"; 

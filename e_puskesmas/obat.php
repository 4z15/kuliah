...
<body id="page-top">
    ...
    <div class="container">
      ...
      <button type="submit" class="btn btn-primary my-3">
        <a href="add_obat.php" class="text-light">Add Medicine</a>
      </button>
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          <?php
            ...
            if (isset($_POST['cari'])) {
                ...
                $sel_obat = " SELECT * FROM `obat` WHERE nama_obat like '$keyword' ";
            }
            else{
                $sel_obat = "SELECT * FROM obat";

            }
            // tampilkan data obat
            $result = mysqli_query($con,$sel_obat);
            if($result){
                ...
                echo '<tr>
                  ...
                  <td>
                    <button type="submit" class="btn btn-primary ">
                      <a href="up_obat.php?upd_id='.$id.'" class="text-light">Update</a>
                    </button>
                    <button type="submit" class="btn btn-danger ">
                      <a href="del_obat.php?del_id='.$id.'" class="text-light">Delete</a>
                    </button>
                  </td>

        ...
        <tbody>
          <?php
            if (isset($_POST['cari'])) {
                ...
                $sel_pasien = " SELECT * FROM `pasien` WHERE nik LIKE '$keyword' or nama_pasien like '$keyword' ";
            }
            else{
                 $sel_pasien = "select id_pasien,nik,nama_pasien,no_telp,j_kelamin,dokter from pasien";
            }

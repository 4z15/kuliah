...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <!-- <a class="collapse-item" href="add_obat.php">Add Medicine</a> -->
   ...
   <div class="container">
      ...
      <table class="table">
        ...
        <tbody>
          <?php
          // cari data pasien dan rekam medis pasien
            if (isset($_POST['cari'])) {
                // code...
                $keyword = $_POST['search'];
                $sel_pasien = " SELECT  rm.id_rekam_medis, p.nama_pasien,p.alamat,rm.keluhan, rm.diagnosa, rm.obat, rm.tanggal,rm.status 
                                FROM `rekam_medis` rm 
                                INNER JOIN pasien p 
                                on rm.id_pasien = p.id_pasien 
                                WHERE p.nama_pasien like '$keyword' ";
            }
            else{
                 
                 $sel_pasien = "SELECT rm.id_rekam_medis, p.nama_pasien,p.alamat,rm.keluhan, rm.diagnosa, rm.obat, rm.tanggal,rm.status FROM `rekam_medis` rm INNER JOIN pasien p on rm.id_pasien = p.id_pasien"; 
            }

           
          // tampilkan data pasien dan rekam medis pasien
                ...
                echo '<tr>
                  ...
                  <td>
                    <button type="submit" class="btn btn-primary ">
                      <a href="up_rek_medis.php?upd_id='.$id.'" class="text-light">Update</a>
                    </button>
                    <button type="submit" class="btn btn-danger ">
                      <a href="del_rekam_medis.php?del_id='.$id.'" class="text-light">Delete</a>
                    </button>
                  </td>

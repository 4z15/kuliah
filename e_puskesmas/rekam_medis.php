...
<body id="page-top">
    ...
    <!--   <button type="submit" class="btn btn-primary my-5">
        <a href="add_rekam_medis.php" class="text-light">Add Medical Records</a>
      </button> -->
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          ...
          <?php
               if (isset($_POST['cari'])) {
                ...
                $sel_pasien = "SELECT rm.id_rekam_medis, p.nama_pasien,p.alamat,rm.keluhan, rm.diagnosa, rm.obat, rm.tanggal 
                FROM `rekam_medis` rm 
                INNER JOIN pasien p 
                ...
                echo '<tr>
                  ...
                  <td>
                    <button type="submit" class="btn btn-primary ">
                      <a href="upd_rekam_medis.php?upd_id='.$id.'" class="text-light">Update</a>
                    </button>

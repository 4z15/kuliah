...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <button type="submit" class="btn btn-primary my-3">
        <a href="up_transaksi.php" class="text-light">Add Transaction</a>
      </button>
      <table class="table">
        <thead>
          <tr>
        ...
        <tbody>
          <?php
            $sel_pasien = "SELECT  tr.id_transaksi,p.nama_pasien,tr.metode_pembayaran,tr.total, rm.tanggal 
FROM `rekam_medis` rm 
INNER JOIN pasien p
on rm.id_pasien = p.id_pasien
INNER JOIN transaksi tr 
on tr.id_rekam_medis = rm.id_rekam_medis
where rm.status = 'Checked' "; 

...
$sel_obat = "select nama_obat,harga_obat from obat where id_obat = $id";
$res = mysqli_query($con,$sel_obat);
...
if (isset($_POST['submit'])){
	...
	$upd_pasien = "update obat set nama_obat ='$nama' ,harga_obat = '$harga' where id_obat = $id" ;
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-3">
                        <h1 class="h3 mb-0 text-gray-800">Parmachist</h1>
...
<div class="container">
			<form method="POST" >
				...
				<div class="mb-3">
					<label >NIK</label>
					<input type="text" class="form-control" placeholder="Enter your NIK" name = "harga" value=<?php 
					echo $harga;
					 ?>>
				</div>

...
if (isset($_POST['submit'])) {
    ...
    // $metode = $_POST['metode'];
    $total= $_POST['total'];
    $metode = implode("", $_POST['metode']);



    $ins_transaksi = "
    INSERT INTO `transaksi` (id_transaksi, total,metode_pembayaran,id_rekam_medis) 
    VALUES (NULL, '$total','$metode','$id')";
    $res = mysqli_query($con, $ins_transaksi);
    if ($res) {
        ...
        <form method="POST">
            <div class="mb-3 my-5">
                <select class="form-select" aria-label="Default select example" name="Id">
                    ...
                    <!-- query select pasien  -->
                    <?php
                    $sel_pasien = "SELECT rm.id_rekam_medis,p.nama_pasien
FROM rekam_medis rm
INNER JOIN pasien p
on rm.id_pasien = p.id_pasien";
                    ...
                    ?>
                        <option value="<?=$row['id_rekam_medis']?>">
                            <?=$row['id_rekam_medis']."--".$nama?>
            ...
            <div class="mb-3 my-3">
                ...
                <select class="form-select" aria-label="Default select example" name="metode[]">
                    <option disable selected>Metode</option>
                    <!-- query select pasien  -->

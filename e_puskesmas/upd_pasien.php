...
if (isset($_POST['submit'])){
	...
	$upd_pasien = "update pasien set nik = '$nik',nama_pasien ='$nama' ,no_telp = '$no_telp',alamat = '$alamat', j_kelamin = '$j_kelamin',dokter ='$dokter' where id_pasien = $id" ;
			...
			<form method="POST" >
				...
				<div class="mb-3">
					...
					<select class="form-select" aria-label="Default select example" name="dokter">
						<option disable selected>Docter</option>
                    <!-- query select pasien  -->
                    <?php
                    $sel_dokter = "select spesialis from dokter";
                    $result = mysqli_query($con,$sel_dokter);
